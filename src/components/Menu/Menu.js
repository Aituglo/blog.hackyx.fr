...
class Menu extends React.Component {
  constructor(props) {
    ...
    this.items = [
      ...
      { to: "/category/", label: "Catégories", icon: FaTag },
      { to: "/search/", label: "Recherche", icon: FaSearch },
      { href: "https://community.hackyx.fr", label: "Forum" },
      { href: "https://discord.hackyx.fr", label: "Discord" },
      { href: "https://hackyx.fr", label: "Site Web" },
    ];
